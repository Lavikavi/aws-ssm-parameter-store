parameters = [
  { name = "dev.frontend.catalogue_url", value = "http://catalogue-dev.devopsb62.online:80/" },
  { name = "dev.frontend.cart_url", value = "http://cart-dev.devopsb62.online:80/" },
  { name = "dev.frontend.user_url", value = "http://user-dev.devopsb62.online:80/" },
  { name = "dev.frontend.shipping_url", value = "http://shipping-dev.devopsb62.online:80/" },
  { name = "dev.frontend.payment_url", value = "http://payment-dev.devopsb62.online:80/" },
  ...
  { name = "dev.shipping.cart_endpoint", value = "cart-dev.devopsb62.online:80" },
